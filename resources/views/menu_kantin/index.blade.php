                  ...
                  <div class="card-body">
                    <div class="col-md-12 col-sm-12 col-xs-12 m-0 p-0 row justify-content-between">
                      <div class="col-12 col-md-3 pl-0">
                        <h4 class="card-title">List Menu Kantin</h4>
                      </div> 
                      <div class="col-12 col-md-5 p-0 text-right">
                        <button type="button" class="btn btn-info" onclick="showcreate()"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Menu</button>
                      </div>
                      </div>
...
baseUrlChange += "/admin/menu-kantin";
...
var table = $('#table-data').DataTable({
        ...
        ajax: {
            url:'{{ url('admin/menu-kantin/table') }}',
        },
        columnDefs: [
