    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb bg-info">
          ...
          <li class="breadcrumb-item active" aria-current="page">Pengajuan Kantin</li>
        </ol>
      </nav>
    </div>
  	<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Data Pengajuan Penarikan Uang Kantin</h4>
  ...
  function terima(id) {
      iziToast.question({
        close: false,
            ...
            $.ajax({
              url:baseUrl + 'admin/approve-withdraw',
