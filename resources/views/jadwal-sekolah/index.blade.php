    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb bg-info">
          ...
          <li class="breadcrumb-item active" aria-current="page">Jadwal Sekolah</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="col-md-12 col-sm-12 col-xs-12 m-0 p-0 row justify-content-between">
            ...
            @if(Auth::user()->role_id == 1 || DB::table("pegawai")->where("is_tata_usaha","Y")->where("user_id",Auth::user()->id)->get()->isNotEmpty() ? true : false)
...
<script>
  ...
  baseUrlChange += "/admin/jadwal-sekolah";
  ...
  var table = $('#table-data').DataTable({
    ...
    ajax: {
      url: '{{ url('admin/jadwal-sekolah/table') }}',
  },
    columnDefs: [
