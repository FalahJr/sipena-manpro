    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb bg-info">
          ...
          <li class="breadcrumb-item active" aria-current="page">Dinas Pendidikan</li>
        </ol>
      </nav>
    </div>
  	<div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Dinas Pendidikan</h4>
...
baseUrlChange += "/admin/dinas-pendidikan";
...
var table = $('#table-data').DataTable({
        ...
        ajax: {
            url:'{{ url('admin/dinas-pendidikan/table') }}',
        },
        columnDefs: [
