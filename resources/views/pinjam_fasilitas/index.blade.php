...
@include('pinjam_fasilitas.tambah')
<style type="text/css">
    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb bg-info">
          ...
          <li class="breadcrumb-item active" aria-current="page">Pinjam Fasilitas</li>
        </ol>
      </nav>
    </div>
...
baseUrlChange += "/admin/pinjam-fasilitas";
...
var table = $('#table-data').DataTable({
        ...
        ajax: {
            url:'{{ url('admin/pinjam-fasilitas/table') }}',
        },
        columnDefs: [
