    ...
    <div class="col-lg-12">
      <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb bg-info">
          <li class="breadcrumb-item"><i class="fa fa-home"></i>&nbsp;<a href="{{url('admin/kepala-sekolah')}}">Kepala Sekolah</a></li>
  	...
  	<div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
           ...
           <h4 class="card-title">Edit Data Kepala Sekolah</h4>
    ...
    <div class="row">
     ...
     @endif
        ...
        <div class="row">
          ...
          <form action="{{url('admin/kepala-sekolah/update')}}" method="POST" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
          <tr>
